...
// Inline SVG icon used instead of react-icons to avoid missing module
...
>
  ...
  >
    <div className="text-[20px] md:text-[22px] font-semibold tracking-tight mb-6">
      {item.label}
    </div>
    ...
    <div className="flex flex-col gap-3">
      {item.links.map((lnk, i) => (
        <Link
          ...
          className="inline-flex items-center gap-2 text-[15px] md:text-[16px] hover:opacity-70 transition-opacity"
        >
